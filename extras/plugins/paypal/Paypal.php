...
class Paypal extends Payment
{
	...
	public static function sendPayment(Request $request, Post $post)
	{
		...
		// dd(config('payment.paypal.mode'));
		// Try to make the Payment
		try {
			$gateway = Omnipay::create('PayPal_Express');
			$gateway->setUsername('sb-hejed7107977_api1.business.example.com');
			$gateway->setPassword('2TDAFK6JD8VG3AFW');
			$gateway->setSignature('AOcXUd3yW2gKCaOVH4o8CJ16NzJsAo7tMvMUlfrqCknAgqHGgHQ8.o5v');
