                        ...
                        <div class="row mb-3 d-flex justify-content-center pl-3 pr-3">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 btn btn-lg btn-fb">
                                    <a href="{{ url('auth/facebook') }}" class="btn-fb"><i
                                            class="icon-facebook-rect"></i> {!! t('Login with Facebook') !!}</a>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 btn btn-lg btn-lkin">
                                    <a href="{{ url('auth/linkedin') }}" class="btn-lkin"><i class="icon-linkedin"></i>
                                        {!! t('Login with LinkedIn') !!}</a>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 btn btn-lg btn-tw">
                                    <a href="{{ url('auth/twitter') }}" class="btn-tw"><i class="icon-twitter-bird"></i>
                                        {!! t('Login with Twitter') !!}</a>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 btn btn-lg btn-danger">
                                    <a href="{{ url('auth/google') }}" class="btn-danger"><i
                                            class="icon-googleplus-rect"></i> {!! t('Login with Google') !!}</a>
                                </div>
                            </div>
                            @endif
                        </div>
            ...
            <div class="col-lg-5 col-md-8 col-sm-10 col-xs-12 login-box">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="login"
                                    class="col-form-label">{{ t('Login') . ' (' . getLoginLabel() . ')' }}:</label>
                            ...
                            @includeFirst([config('larapen.core.customizedViewPath') . 'layouts.inc.tools.recaptcha',
                            'layouts.inc.tools.recaptcha'], ['noLabel' => true])
                ...
                <div class="login-box-btm text-center">
                    <p>
                        ...
                        <a class="do-not-have-account"
                            href="{{ \App\Helpers\UrlGen::register() }}"><strong>{{ t('Sign Up') }} !</strong></a>
                    </p>
                </div>
            </div>
