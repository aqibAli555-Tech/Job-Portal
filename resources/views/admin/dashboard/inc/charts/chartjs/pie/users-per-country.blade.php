...
$countUsersLabels = (isset($usersDataArr['labels']) && is_array($usersDataArr['labels']) && count($usersDataArr['labels']) > 0) ? count($usersDataArr['labels']) : 0;
@endphp
...
<script>
    ...
    @if($countUsersLabels > 0)
    @php
    $usersDisplayLegend = ($countUsersLabels <= 1) ? 'true' : 'false';
    @endphp
    var config = {
