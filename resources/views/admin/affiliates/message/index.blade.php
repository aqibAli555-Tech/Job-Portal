...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            @include('admin.affiliates.message.threads')
        ...
        <div class="row">
            <form id="chatAffiliateForm" role="form" method="POST" action="" enctype="multipart/form-data">
        ...
        @includeFirst([config('larapen.core.customizedViewPath') . 'admin.models.start_new_affiliate_conversation','admin.models.start_new_affiliate_conversation'])
        @endsection
