            ...
            <div class="row">
                        ...
                        <div class="footer-col">
                            ...
                            <ul class="list-unstyled footer-nav">
                                @if (!auth()->user())
                                    ...
                                    <li><a href="#register_popup" data-toggle="modal"
                                           data-target="#register_popup"> {{ t('Register') }} </a></li>
                                @else
                                                    ...
                                                    <div class="col-xs-12 col-sm-6">
                                                        <a class="app-icon" target="_blank"
                                                           href="{{ config('settings.other.ios_app_url') }}">
                                                            ...
                                                            <img src="{{ url()->asset('images/site/app-store-badge.svg') }}"
                                                    ...
                                                    <div class="col-xs-12 col-sm-6">
                                                        <a class="app-icon" target="_blank"
                                                           href="{{ config('settings.other.android_app_url') }}">
                                                            ...
                                                            <img src="{{ url()->asset('images/site/google-play-badge.svg') }}"
                ...
                <div class="col-xl-12">
                    ...
                    <div class="footer-payment-icons float-right d-inline-block">
                        <img src="{{url()->asset('images/visa.svg')}}" alt="visa" class="lazyload" width="50"
                             height="30">
                        <img src="{{url()->asset('images/mastercard.svg')}}" alt="mastercard" class="lazyload"
                             width="50" height="30">
                        <img src="{{url()->asset('images/apple.jpg')}}" alt="apple pay" class="lazyload" width="50"
                             height="30">
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <a href="<?= url('register') ?>?user_type_id=2" class="btn btn-block btn btn-success btn-register "
                       style="color:white;font-size: 14px; width:auto;"><i class="icon-user"></i>Register as Employee
                        (Job Seeker)</a>

                </div>
                <div class="mb-3">
                    <a href="<?= url('register') ?>?user_type_id=1" class="btn btn-block btn btn-success btn-register"
                       style="color:white;font-size: 14px; width:auto;"><i class="icon-town-hall"></i>Register as
                        Employer (Company)</a>
                </div>
