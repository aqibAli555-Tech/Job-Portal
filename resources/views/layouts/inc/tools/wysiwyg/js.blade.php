...
<script type="text/javascript">
    ...
    tinymce.addI18n('{{ config('
    app.locale
    ') }}', <?php echo $editorI18nJson; ?>)
...
?>
@if ($editorLocale != 'en')
<script src="{{ asset('/plugins/ckeditor/translations/' . $editorLocale . '.js') }}"></script>
@endif
<script type="text/javascript">
...
<script src="{{ asset('/plugins/simditor/scripts/mobilecheck.js') }}"></script>
<script src="{{ asset('/plugins/simditor/scripts/module.js') }}"></script>
<script src="{{ asset('/plugins/simditor/scripts/hotkeys.js') }}"></script>
<script src="{{ asset('/plugins/simditor/scripts/dompurify.js') }}"></script>
<script src="{{ asset('/plugins/simditor/scripts/simditor.js') }}"></script>
<?php
    ...
    (function () {
        ...
        @endif
            ...
            editor = new Simditor({
                ...
                defaultImage: '{{ asset(' / plugins / simditor / images / image.png') }}',
                pasteImage: false,
                upload: false
            });
