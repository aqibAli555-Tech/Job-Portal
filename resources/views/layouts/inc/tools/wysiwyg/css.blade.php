...
<link media="all" rel="stylesheet" type="text/css" href="{{ asset('plugins/simditor/styles/simditor.css') }}"/>
@if (config('lang.direction') == 'rtl')
<link media="all" rel="stylesheet" type="text/css" href="{{ asset('plugins/simditor/styles/simditor-rtl.css') }}"/>
@endif
@endif
