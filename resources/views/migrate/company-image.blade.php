...
<section class="py-5">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow text-center h-100">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Total Company Pictures</h5>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow text-center h-100">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Pending Company Pictures to AWS</h5>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow text-center h-100">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Uploaded Company Pictures to AWS</h5>
            ...
            <div class="col-md-3">
                <a href="{{ url('migration/error-company-images') }}" target="_blank" class="text-decoration-none">
                    <div class="card border-0 shadow text-center h-100">
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <h5 class="card-title">Total Error Company Pictures to Upload</h5>
            ...
            <!-- Error profile pictures -->
            <div class="col-md-3">
                <a href="{{ url('migration/error-company-images') }}?error_status=2" target="_blank" class="text-decoration-none">
                    <div class="card border-0 shadow text-center h-100">
                        <div class="card-body">
                            <div class="mb-3">
                                <span class="text-danger">
             ...
             <!-- Error profile pictures -->
            <div class="col-md-3">
                <a href="{{ url('migration/error-company-images') }}?error_status=3" target="_blank" class="text-decoration-none">
                    <div class="card border-0 shadow text-center h-100">
                        <div class="card-body">
                            <div class="mb-3">
                                <span class="text-warning">
            ...
            <!-- Error profile pictures -->
            <div class="col-md-3">
                <a href="{{ url('migration/error-company-images') }}?error_status=4" target="_blank" class="text-decoration-none">
                    <div class="card border-0 shadow text-center h-100">
                        <div class="card-body">
                            <div class="mb-3">
                                <span class="text-danger">
            ...
            <!-- Error profile pictures -->
            <div class="col-md-3">
                <a href="{{ url('migration/error-company-images') }}?error_status=5" target="_blank" class="text-decoration-none">
                    <div class="card border-0 shadow text-center h-100">
                        <div class="card-body">
                            <div class="mb-3">
                                <span class="text-warning">
...
<script>
    ...
    function get_all_picture_count(btn) {
        ...
        $.ajax({
            method: 'GET',
            url: "<?= url('migration/profile-image-companies') ?>",
            dataType: 'json',
    ...
    function import_picture(response, index) {
        ...
        if (index < 10) {
            $.ajax({
                method: 'GET',
                dataType: 'json',
                url: "<?= url('migration/move_company_image_to_aws') ?>",
                data: "id=" + response.companies[index].id,
                success: function (response_user) {
                    ...
                    $('#image_progress table tbody').append('<tr><td>' + response.companies[index].id + '</td><td class="' + messageClass + '">' + response_user.message + '</td></tr>');
    ...
    function get_error_uploading_picture(btn) {
        ...
        $.ajax({
            method: 'GET',
            url: "<?= url('migration/profile-error-image-companies') ?>",
            dataType: 'json',
            success: function (response) {
                if (response.error > 0) {
                    $('.completed').text(response.completed);
