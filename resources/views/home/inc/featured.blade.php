                ...
                <div class="large-12 columns">
                    <div class="no-margin featured-list-slider owl-carousel owl-theme">
                        ...
                        if (empty($post->logo)) {
                            ...
                            if (file_exists(public_path('/') . 'storage/' . $post->logo)) {
                                $logo_show = $post->logo;
                            } else {
                                $logo_show = 'app/default/picture.jpg';
                            }
...
<script>
    ...
    var carouselItems = {
    {
        (isset($featured) and isset($featured->posts))? collect($featured->posts)->count():0}
    }

    var carouselAutoplay = {
    {
        (isset($featuredOptions) && isset($featuredOptions['autoplay'])) ? $featuredOptions['autoplay'] : 'false'
    }
    }

    var carouselAutoplayTimeout = {
    {
        (isset($featuredOptions) && isset($featuredOptions['autoplay_timeout'])) ? $featuredOptions['autoplay_timeout'] : 1500
    }
    }
