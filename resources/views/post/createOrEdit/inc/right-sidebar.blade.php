<div class="reg-sidebar-inner text-center">
    ...
    <div class="promo-text-box">
        <img style="width: 57px" src="{{url()->asset('/icon/10.png')}}"/>
        ...
        <div class="card-content user-info">
            <div class="card-body text-center">
                ...
                <a href="{{ url('posts/' . $post->id . '/payment') }}"
                   class="btn btn-success btn-block" hidden>
    ...
    <div class="card sidebar-card border-color-primary" hidden>
        <div class="card-header bg-primary border-color-primary text-white uppercase">
            <small><strong>{{ t('How to quickly find a candidate?') }}</strong></small>
        </div>
