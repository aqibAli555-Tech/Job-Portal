...
use App\Country as get_country;
...
<div style="background: #79598d;height: 45px;border: none;padding: 20px">
    <img src="https://hungryforjobs.com/storage/app/public/app/icon/hfjpdf.png" alt="Hungry For Jobs" height="70px">
...
<div class="main">
    <div class="left">
        ...
        <h1 style="text-align: left;color: #635987;font-family: 'Lato', sans-serif;font-size: 24px">
            {{ strtoupper($data->fullName) }} {{ strtoupper($data->fatherName) }}
        </h1>
        <br>
        ...
        <div style="padding: 20px;background: #f1f0f0;text-align: center">
            ...
            <br>
            <br>
            <a target="_blank" href="{{url('profile/'.$data->id)}}" target="_blank" class="category_item1" style="text-decoration: none; "><img src="https://hungryforjobs.com/storage/app/public/app/icon/eye.png" alt="" style=""> VIEW CONTACT CARD</a>
            <a target="_blank" href="{{url('profile/'.$data->id)}}" target="_blank" class="category_item1" style="text-decoration: none"><img src="https://hungryforjobs.com/storage/app/public/app/icon/eye.png" alt="">VIEW PROFILE</a>
    ...
    <div class="right">
        <div style="width: 100% ; display: block">
            ...
            <div style="width: 100%">
                ...
                <?php
                $data_country = get_country::where('code', $data->sillExperienceCoutry[$loop->index])->first();
                $data_country1 = json_decode($data_country->name); ?>
                <div style="padding: 5px;padding-left: 0">
                    <h4>{{$data->sillExperienceComapny[$loop->index]}}</h4>
                    <p>
                        {{$data_country1->en}} - {{$data->sillExperienceCity[$loop->index]}}<br>
                        {{$skil}} - {{$data->experience[$loop->index]}}
                        <br>

                        <? echo date("F Y", strtotime($data->sillExperiencestartdate[$loop->index])); ?> - <? echo date("F Y", strtotime($data->sillExperienceenddate[$loop->index])); ?>
                        <br>
                        {{$data->sillExperienceDis[$loop->index]}}
                    </p>
                </div>
                @endforeach
            </div>
...
<div style="background: #79598d;height: 18px;border: none;padding: 20px;position: fixed;bottom: 0;width: 100%;">
    <a target="_blank" href="https://www.facebook.com/Hungry-For-Jobs-726772877757699"><img src="https://hungryforjobs.com/storage/app/public/app/icon/awesome-facebook-f.svg?version=<?= time() ?>" alt="" style="height: 21px;"></a>&nbsp;
    <a target="_blank" href="https://www.instagram.com/HungryForJobs/"><img src="https://hungryforjobs.com/storage/app/public/app/icon/metro-instagram.svg?version=<?= time() ?>" alt="" style=" width: 20px;"></a>&nbsp;
    <a target="_blank" href="https://www.linkedin.com/company/hungryforjobs"><img src="https://hungryforjobs.com/storage/app/public/app/icon/awesome-linkedin.svg?version=<?= time() ?>" alt="" style=" width: 20px;"></a>
    <a target="_blank" href="https://hungryforjobs.com" style="float: right;color:#fff;text-decoration:none;font-size:13px;">www.hungryforjobs.com</a>
</div>
</body>
</html>
