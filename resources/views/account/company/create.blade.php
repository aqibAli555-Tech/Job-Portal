                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        <div class="card card-default">
                            <div class="card-header">
                                <h4 class="card-title"><a href="#companyPanel" data-toggle="collapse" data-parent="#accordion" class="card-title-create-staff"> {{ t('Company Information') }} </a></h4>
                            </div>
                            <div class="panel-collapse collapse show" id="companyPanel">
                                <div class="card-body">
                                    <form name="company" class="form-horizontal" role="form" method="POST" action="{{ url('account/companies') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 control-label">Entities <span style="color: red;">*</span> </label>
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    <select class="skill_set_entities form-control" multiple required="required" name="entities[]">
