...
<div id="resumeFields">
    ...
    <div class="form-group row">
        ...
        <div class="{{ $classRightCol }}">
            ...
            <small id="" class="form-text text-muted">{{ t('File types', ['file_types' => showValidFileTypes('file')]) }}</small>
            @if (isset($resume))
    ...
    <!-- filename -->
    <?php $resumeFilenameError = (isset($errors) and $errors->has('resume.filename')) ? ' is-invalid' : ''; ?>
    <div class="form-group required" {!! (config(
    'lang.direction')=='rtl') ? 'dir="rtl"' : '' !!}>
