        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9 page-content">
                        ...
                        <div class="row">
                            <div class="col-md-5 col-xs-4 col-xxs-12">
                                <h3 class="no-padding text-center-480 useradmin">
                                    @php
                                        $imageUrl = \App\Helpers\Helper::getImageOrThumbnailLink(auth()->user());
                                    @endphp
                                    <a href="">
                            ...
                            @if(!empty(auth()->user()->parent_id))
                                <div class="col-md-8 col-xs-8 col-xxs-12" hidden>
                                    <div class="header-data text-center-xs">
                                            ...
                                            <div class="mcol-right">
                                                <p>
                                                    <a href="{{ url('account/messages') }}">
                                                        ...
                                                        <em>{{ trans_choice('global.Messages', getPlural($countThreads)) }}</em>
                                                    </a>
                                                </p>
                                            </div>
                                        ...
                                        @if (!empty($user) and in_array($user->user_type_id, [1]))
                                            <div class="hdata">
                                                <div class="mcol-left">
                                                ...
                                                <div class="mcol-right">
                                                    <p>
                                                        <a href="{{ url('account/my-posts') }}">
                                                            ...
                                                            <em>{{ trans_choice('global.Jobs visit', getPlural($totalPostsVisits)) }}</em>
                                                        </a>
                                                    </p>
                                                </div>
                                                <div class="clearfix"></div>
                                        ...
                                        @endif
                                        @if (!empty($user) and in_array($user->user_type_id, [2]))
                                            <div class="hdata">
                                                <div class="mcol-left">
                                                ...
                                                <div class="mcol-right">
                                                    <p>
                                                        <a href="{{ url('account/favourite') }}">
                                                            ...
                                                            <em>{{ trans_choice('global.count_favorites', getPlural($countFavoritePosts)) }}
                                                            </em>
                                                        </a>
                                                    </p>
                                                </div>
                                        ...
                                        @if (isset($user) and in_array($user->user_type_id, [1]))
                                            <div class="hdata">
                                                ...
                                                <div class="mcol-right">
                                                    <p>
                                                        <a>
                                                            {{ \App\Helpers\Number::short(auth()->user()->credits - auth()->user()->remaining_credits) }}
                                                            /{{auth()->user()->credits}}
                                                            Remaining <br>Credit
                                                        </a>
                                                    </p>
                                        ...
                                        @if (isset($user) and in_array($user->user_type_id, [1]))
                                            <div class="hdata">
                                                ...
                                                <div class="mcol-right">
                                                    <p>
                                                        <a>
                                                            {{ \App\Helpers\Number::short(auth()->user()->posts - auth()->user()->remaining_posts) }}
                                                            /{{auth()->user()->posts}}
                                                            Remaining <br>Posts
                                                        </a>
                                                    </p>
                                ...
                                <div class="panel-collapse collapse {{ (old('panel')=='' or old('panel')=='userPanel') ? 'show' : '' }}"
                                    ...
                                    <div class="card-body">
                                        <form name="details" id="updateprofile" method="POST"
                                              action="{{ url('/account/update_profile') }}"
                    ...
                    <br>
                    @include('account.inc.email_settings')
                    <br>
                    <!-- SETTINGS -->
