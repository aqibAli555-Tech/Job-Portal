			...
			<div class="row">
												...
												@if (config('settings.other.ios_app_url'))
													<div class="col-xs-12 col-sm-6">
														<a class="app-icon" target="_blank" href="{{ config('settings.other.ios_app_url') }}">
															...
															<img src="{{ url('public/images/site/app-store-badge.svg') }}" alt="{{ t('Available on the App Store') }}">
														</a>
													</div>
												@endif
												@if (config('settings.other.android_app_url'))
													<div class="col-xs-12 col-sm-6">
														<a class="app-icon" target="_blank" href="{{ config('settings.other.android_app_url') }}">
															...
															<img src="{{ url('public/images/site/google-play-badge.svg') }}" alt="{{ t('Available on Google Play') }}">
														</a>
													</div>
												@endif
											</div>
				...
				<div class="col-xl-12">
					...
					<div class="copy-info text-center">
						© 2022 {{ config('settings.app.app_name') }}. {{ t('All Rights Reserved') }}.
