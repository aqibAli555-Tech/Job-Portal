        ...
        <div class="container">
            ...
            <div class="navbar-identity">
                ...
                <button class="flag-menu country-flag d-block d-md-none btn btn-secondary hidden pull-right" href="#selectCountry" data-toggle="modal">
                    <img src="{{ url()->assets('/images/flags/24/' . config('country.icode') . '.png') . getPictureVersion() }}"
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="flag-menu country-flag tooltipHere hidden-xs nav-item" data-toggle="tooltip" data-placement="{{ (config('lang.direction') == 'rtl') ? 'bottom' : 'right' }}">
                        ...
                        <a href="#selectCountry" data-toggle="modal" class="nav-link">
                            <img class="flag-icon"
                                 src="url()->asset('images/flags/32/' . config('country.icode') . '.png') . getPictureVersion() }}"
                                 alt="{{ config('country.name') }}"
                            >
                ...
                <ul class="nav navbar-nav ml-auto navbar-right">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{ \App\Helpers\UrlGen::logout() }}" class="nav-link">
                            <i class="glyphicon glyphicon-off"></i> {{ t('Logout') }}
                        </a>
                        @endif
                    </li>
