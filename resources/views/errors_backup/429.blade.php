...
@section('title', t('Too many requests you can hit only 60 requests in 1 mints'))
                    ...
                    <div class="error-page mt-5 mb-5 ml-0 mr-0 pt-5">
                        ...
                        <div class="text-center m-l-0 mt-5">
                            <h3 class="m-t-0 color-danger">
                                <i class="fas fa-exclamation-triangle"></i> {{ t('Too many requests you can hit only 60 requests in 1 mints') }}
                            </h3>
                            <p>
                                <?php
