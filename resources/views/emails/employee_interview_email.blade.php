    ...
    <table>
        ...
        <tr>
            ...
            <td style="padding: 20px;">
                Company <?= $Company_name; ?> has shortlisted you for a potential interview for the position of <?= $title ?> that you have applied for. <br><br>
                If Company <?= $Company_name; ?> chooses you between other shortlisted applicants and is interested, they will contact you by the phone number and/or email you put on your CV.<br>
