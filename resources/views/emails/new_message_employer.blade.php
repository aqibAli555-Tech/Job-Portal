...
<div class="body" style="width: 100%; ">
    <table>
        ...
        <tr>
            <td style="padding-left: 20px;padding-right:20px ;">You have received a direct message from Job Seekers {{$from_user_name}}.
                <a href="{{url('account/messages')}}" target="_blank"
                   style="color:#7ed0de;text-decoration: underline;cursor: pointer;">Click here</a> to view and reply.
                <br><br>
