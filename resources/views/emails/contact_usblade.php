...
<div class="body" style="width: 100%; ">
    <table>
        ...
        <tr>
            <td style="padding-left: 20px;padding-right:20px;">An employee (job seeker) has applied to your job offer {{$postname}}, <a href="{{url('account/Applicants')}}" target="_blank" style="color:#7ed0de;text-decoration: underline;cursor: pointer;">Click here</a> to view & accept/reject.
                <br><br>
