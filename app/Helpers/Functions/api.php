...
{
    if (isFromApi()) {
        $isPostCreationRequest = (str_contains(Route::currentRouteAction(), 'Api\PostController@store'));
    } else {
        $isNewEntryUri = (
            (
        ...
        $isPostCreationRequest = (
            $isNewEntryUri
            || str_contains(Route::currentRouteAction(), 'Web\Post\CreateOrEdit\MultiSteps\CreateController')
            || str_contains(Route::currentRouteAction(), 'Web\Post\CreateOrEdit\SingleStep\CreateController')
        );
    }
