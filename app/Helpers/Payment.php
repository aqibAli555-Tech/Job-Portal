...
use Exception;
use extras\plugins\apijc\app\Http\Resources\PaymentResource;
...
class Payment
{
     ...
     * @param Post $post
     * @param $params
     * @return PaymentModel|JsonResponse|null
     */
    ...
    public static function paymentApiErrorActions1($post, $exception)
    {
        // Remove the entry
        self::removeEntry($post);
