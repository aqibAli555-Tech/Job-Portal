...
class UrlGen
{
    ...
    /**
     * @param $entry
     * @return bool|UrlGenerator|mixed|string|null
     */
    ...
    /**
     * @param $entry
     * @return false|UrlGenerator|string|null
     */
     ...
     * @return Application|UrlGenerator|mixed|string
     */
    public static function city($entry, $countryCode = null, $cat = null, $cityid = null)
    {
        ...
        if (isset($entry->id, $entry->name)) {
            ...
            if (!empty($cityid)) {
                ...
                if (str_contains($actual_link, '&l=')) {
                    $url = str_replace('&l=' . request()->get('l'), '&l=' . $cityid, $actual_link);
                } else {
                    if (str_contains($actual_link, '?q=')) {
                        $url = str_replace('?q=' . request()->get('q'), '?q=' . request()->get('q') . '&l=' . $cityid, $actual_link);
                    } else {
                        $url = str_replace('latest-jobs', 'latest-jobs?q=&l=' . $cityid, $actual_link);
    ...
    public static function user3($entry, $countryCode = null)
    {
        if (empty($countryCode)) {
            $countryCode = config('country.code');
        }
    ...
    public static function user2($entry, $countryCode = null)
    {
        if (empty($countryCode)) {
            $countryCode = config('country.code');
        }
