...
class EmployerController extends AdminBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vendor.admin.employer.index', compact('users'));
    }
    ...
    public function get_top_country_employer()
    {
        ...
        return view('vendor.admin.employer.top_country_employer', compact('top_country_employers'));
    }
    ...
    public function get_top_skill_posts()
    {
        ...
        return view('vendor.admin.employer.top_skill_posts', compact('top_skill_posts'));
    }
