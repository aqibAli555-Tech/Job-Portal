...
class AssignCreditsController extends PanelController
{
    public function view()
    {
        ...
        return view('admin.company.assignCredits',compact('title','breadcumbs'));
    }
    ...
    public function search_user_by_email(Request $request)
    {
        ...
        if (!empty($request['email'])) {
            ...
            $data['user'] = $user;
            return view('admin.company.assignCredits')->with('data', $data);
        } else {
            return view('admin.company.assignCredits');
        }
    }
