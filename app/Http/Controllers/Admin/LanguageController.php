...
class LanguageController extends PanelController
{
    ...
    {
        ini_set('max_input_vars', 50000000000);
    ...
    public function showTexts(LanguageFiles $langFile, Language $languages, $lang = '', $file = 'site')
    {
        ...
        $this->data['currentLangObj'] = Language::where('abbr', '=', $this->data['currentLang'])->where('active', 1)->first();
        $this->data['browsingLangObj'] = Language::where('abbr', '=', config('app.locale'))->where('active', 1)->first();
        $this->data['languages'] = $languages->where('active', 1)->orderBy('name')->get();
